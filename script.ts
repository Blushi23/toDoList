...
function showTasksInLists() {
    ...
    for (let task of manager.tasks) {
        if (task.completed == false) {
            ...
            switch (task.dueDate) {
                case "12months":
                    document.getElementById("12months")!.innerHTML += `<div><span><button class="btn fullHeart" onclick="undoTaskComplition(${task.id})"><i class="fa-solid fa-heart"></i></button></span> <li class="complete-list d-inline-block w-50 text-decoration-line-through">${task.description}</li> <span>
            ...
            <button class="btn trash" disabled><i class="fa-solid fa-trash"></i></button></span>
                    ...
                    break;
                case "6months":
                    document.getElementById("6months")!.innerHTML += `<div><span><button class="btn fullHeart" onclick="undoTaskComplition(${task.id})"><i class="fa-solid fa-heart"></i></button></span> <li class="complete-list d-inline-block w-50 text-decoration-line-through">${task.description}</li> <span>
            <button class="btn edit" disabled><i class="fa-solid fa-pen"></i></button>
            <button class="btn trash" disabled><i class="fa-solid fa-trash"></i></button></span>
            </div> `;
                    break;
                case "3months":
                    document.getElementById("3months")!.innerHTML += `<div><span><button class="btn fullHeart" onclick="undoTaskComplition(${task.id})"><i class="fa-solid fa-heart"></i></button></span> <li class="complete-list d-inline-block w-50 text-decoration-line-through">${task.description}</li> <span>
            <button class="btn edit" disabled><i class="fa-solid fa-pen"></i></button>
            <button class="btn trash" disabled><i class="fa-solid fa-trash"></i></button></span>
            </div> `;
                    break;
                case "1month":
                    document.getElementById("1month")!.innerHTML += `<div><span><button class="btn fullHeart" onclick="undoTaskComplition(${task.id})"><i class="fa-solid fa-heart"></i></button></span> <li class="complete-list d-inline-block w-50 text-decoration-line-through">${task.description}</li> <span>
            <button class="btn edit" disabled><i class="fa-solid fa-pen"></i></button>
            <button class="btn trash" disabled><i class="fa-solid fa-trash"></i></button></span>
            </div> `;
                    break;
                case "1week":
                    document.getElementById("1week")!.innerHTML += `<div><span><button class="btn fullHeart" onclick="undoTaskComplition(${task.id})"><i class="fa-solid fa-heart"></i></button></span> <li class="complete-list d-inline-block w-50 text-decoration-line-through">${task.description}</li> <span>
            <button class="btn edit" disabled><i class="fa-solid fa-pen"></i></button>
            <button class="btn trash" disabled><i class="fa-solid fa-trash"></i></button></span>
            </div> `;
                    break;
                case "theDay":
                    document.getElementById("theDay")!.innerHTML += `<div><span><button class="btn fullHeart" onclick="undoTaskComplition(${task.id})"><i class="fa-solid fa-heart"></i></button></span> <li class="complete-list d-inline-block w-50 text-decoration-line-through">${task.description}</li> <span>
            <button class="btn edit" disabled><i class="fa-solid fa-pen"></i></button>
            <button class="btn trash" disabled><i class="fa-solid fa-trash"></i></button></span>
            </div> `;
                    break;
                case "after":
                    document.getElementById("after")!.innerHTML += `<div><span><button class="btn fullHeart" onclick="undoTaskComplition(${task.id})"><i class="fa-solid fa-heart"></i></button></span> <li class="complete-list d-inline-block w-50 text-decoration-line-through">${task.description}</li> <span>
            <button class="btn edit" disabled><i class="fa-solid fa-pen"></i></button>
            <button class="btn trash" disabled><i class="fa-solid fa-trash"></i></button></span>
            </div> `;
                    break;
