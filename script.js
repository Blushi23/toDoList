...
// const dueDateSelect = document.getElementById("dueDate") as HTMLSelectElement;
// const columns = ["12months", "6months", "3months", "1month", "1week", "theDay", "after"];
...
function showTasksInLists() {
    ...
    for (var _i = 0, _a = manager.tasks; _i < _a.length; _i++) {
        ...
        if (task.completed == false) {
            switch (task.dueDate) {
                case "12months":
                    document.getElementById("12months").innerHTML += "<div> <span><button class=\"btn heart\" onclick=\"completeTask(".concat(task.id, ")\"><i class=\"fa-regular fa-heart\"></i></button></span><li class=\"active-list d-inline-block w-50\">").concat(task.description, "</li> <span> <button class=\"btn edit\" onclick=\"updateDescription(").concat(task.id, ")\"><i class=\"fa-solid fa-pen\"></i></button> <button class=\"btn trash\" onclick=\"deleteTask(").concat(task.id, ")\"><i class=\"fa-solid fa-trash\"></i></button></span> </div> ");
                    break;
                case "6months":
                    document.getElementById("6months").innerHTML += "<div> <span><button class=\"btn heart\" onclick=\"completeTask(".concat(task.id, ")\"><i class=\"fa-regular fa-heart\"></i></button></span><li class=\"active-list d-inline-block w-50\">").concat(task.description, "</li> <span> <button class=\"btn edit\" onclick=\"updateDescription(").concat(task.id, ")\"><i class=\"fa-solid fa-pen\"></i></button> <button class=\"btn trash\" onclick=\"deleteTask(").concat(task.id, ")\"><i class=\"fa-solid fa-trash\"></i></button></span> </div> ");
                    break;
                case "3months":
                    document.getElementById("3months").innerHTML += "<div> <span><button class=\"btn heart\" onclick=\"completeTask(".concat(task.id, ")\"><i class=\"fa-regular fa-heart\"></i></button></span><li class=\"active-list d-inline-block w-50\">").concat(task.description, "</li> <span> <button class=\"btn edit\" onclick=\"updateDescription(").concat(task.id, ")\"><i class=\"fa-solid fa-pen\"></i></button> <button class=\"btn trash\" onclick=\"deleteTask(").concat(task.id, ")\"><i class=\"fa-solid fa-trash\"></i></button></span> </div> ");
                    break;
                case "1month":
                    document.getElementById("1month").innerHTML += "<div> <span><button class=\"btn heart\" onclick=\"completeTask(".concat(task.id, ")\"><i class=\"fa-regular fa-heart\"></i></button></span><li class=\"active-list d-inline-block w-50\">").concat(task.description, "</li> <span> <button class=\"btn edit\" onclick=\"updateDescription(").concat(task.id, ")\"><i class=\"fa-solid fa-pen\"></i></button> <button class=\"btn trash\" onclick=\"deleteTask(").concat(task.id, ")\"><i class=\"fa-solid fa-trash\"></i></button></span> </div> ");
                    break;
                case "1week":
                    document.getElementById("1week").innerHTML += "<div> <span><button class=\"btn heart\" onclick=\"completeTask(".concat(task.id, ")\"><i class=\"fa-regular fa-heart\"></i></button></span><li class=\"active-list d-inline-block w-50\">").concat(task.description, "</li> <span> <button class=\"btn edit\" onclick=\"updateDescription(").concat(task.id, ")\"><i class=\"fa-solid fa-pen\"></i></button> <button class=\"btn trash\" onclick=\"deleteTask(").concat(task.id, ")\"><i class=\"fa-solid fa-trash\"></i></button></span> </div> ");
                    break;
                case "theDay":
                    document.getElementById("theDay").innerHTML += "<div> <span><button class=\"btn heart\" onclick=\"completeTask(".concat(task.id, ")\"><i class=\"fa-regular fa-heart\"></i></button></span><li class=\"active-list d-inline-block w-50\">").concat(task.description, "</li> <span> <button class=\"btn edit\" onclick=\"updateDescription(").concat(task.id, ")\"><i class=\"fa-solid fa-pen\"></i></button> <button class=\"btn trash\" onclick=\"deleteTask(").concat(task.id, ")\"><i class=\"fa-solid fa-trash\"></i></button></span> </div> ");
                    break;
                case "after":
                    document.getElementById("after").innerHTML += "<div> <span><button class=\"btn heart\" onclick=\"completeTask(".concat(task.id, ")\"><i class=\"fa-regular fa-heart\"></i></button></span><li class=\"active-list d-inline-block w-50\">").concat(task.description, "</li> <span> <button class=\"btn edit\" onclick=\"updateDescription(").concat(task.id, ")\"><i class=\"fa-solid fa-pen\"></i></button> <button class=\"btn trash\" onclick=\"deleteTask(").concat(task.id, ")\"><i class=\"fa-solid fa-trash\"></i></button></span> </div> ");
                    break;
                default:
                    break;
            }
            ...
            switch (task.dueDate) {
                case "12months":
                    document.getElementById("12months").innerHTML += "<div><span><button class=\"btn fullHeart\" onclick=\"undoTaskComplition(".concat(task.id, ")\"><i class=\"fa-solid fa-heart\"></i></button></span> <li class=\"complete-list d-inline-block w-50 text-decoration-line-through\">").concat(task.description, "</li> <span>\n            <button class=\"btn edit\" disabled><i class=\"fa-solid fa-pen\"></i></button>\n            <button class=\"btn trash\" disabled><i class=\"fa-solid fa-trash\"></i></button></span>\n            </div> ");
                    break;
                case "6months":
                    document.getElementById("6months").innerHTML += "<div><span><button class=\"btn fullHeart\" onclick=\"undoTaskComplition(".concat(task.id, ")\"><i class=\"fa-solid fa-heart\"></i></button></span> <li class=\"complete-list d-inline-block w-50 text-decoration-line-through\">").concat(task.description, "</li> <span>\n            <button class=\"btn edit\" disabled><i class=\"fa-solid fa-pen\"></i></button>\n            <button class=\"btn trash\" disabled><i class=\"fa-solid fa-trash\"></i></button></span>\n            </div> ");
                    break;
                case "3months":
                    document.getElementById("3months").innerHTML += "<div><span><button class=\"btn fullHeart\" onclick=\"undoTaskComplition(".concat(task.id, ")\"><i class=\"fa-solid fa-heart\"></i></button></span> <li class=\"complete-list d-inline-block w-50 text-decoration-line-through\">").concat(task.description, "</li> <span>\n            <button class=\"btn edit\" disabled><i class=\"fa-solid fa-pen\"></i></button>\n            <button class=\"btn trash\" disabled><i class=\"fa-solid fa-trash\"></i></button></span>\n            </div> ");
                    break;
                case "1month":
                    document.getElementById("1month").innerHTML += "<div><span><button class=\"btn fullHeart\" onclick=\"undoTaskComplition(".concat(task.id, ")\"><i class=\"fa-solid fa-heart\"></i></button></span> <li class=\"complete-list d-inline-block w-50 text-decoration-line-through\">").concat(task.description, "</li> <span>\n            <button class=\"btn edit\" disabled><i class=\"fa-solid fa-pen\"></i></button>\n            <button class=\"btn trash\" disabled><i class=\"fa-solid fa-trash\"></i></button></span>\n            </div> ");
                    break;
                case "1week":
                    document.getElementById("1week").innerHTML += "<div><span><button class=\"btn fullHeart\" onclick=\"undoTaskComplition(".concat(task.id, ")\"><i class=\"fa-solid fa-heart\"></i></button></span> <li class=\"complete-list d-inline-block w-50 text-decoration-line-through\">").concat(task.description, "</li> <span>\n            <button class=\"btn edit\" disabled><i class=\"fa-solid fa-pen\"></i></button>\n            <button class=\"btn trash\" disabled><i class=\"fa-solid fa-trash\"></i></button></span>\n            </div> ");
                    break;
                case "theDay":
                    document.getElementById("theDay").innerHTML += "<div><span><button class=\"btn fullHeart\" onclick=\"undoTaskComplition(".concat(task.id, ")\"><i class=\"fa-solid fa-heart\"></i></button></span> <li class=\"complete-list d-inline-block w-50 text-decoration-line-through\">").concat(task.description, "</li> <span>\n            <button class=\"btn edit\" disabled><i class=\"fa-solid fa-pen\"></i></button>\n            <button class=\"btn trash\" disabled><i class=\"fa-solid fa-trash\"></i></button></span>\n            </div> ");
                    break;
                case "after":
                    document.getElementById("after").innerHTML += "<div><span><button class=\"btn fullHeart\" onclick=\"undoTaskComplition(".concat(task.id, ")\"><i class=\"fa-solid fa-heart\"></i></button></span> <li class=\"complete-list d-inline-block w-50 text-decoration-line-through\">").concat(task.description, "</li> <span>\n            <button class=\"btn edit\" disabled><i class=\"fa-solid fa-pen\"></i></button>\n            <button class=\"btn trash\" disabled><i class=\"fa-solid fa-trash\"></i></button></span>\n            </div> ");
                    break;
                default:
                    break;
            }
